    ...
    return [
        ...
        'components' => [
            ...
            'shared' => [
                ...
                'mail_recipients'   => ['title' => '收件人'         , 'description' => 'Specify email recipients. Use email addresses as keys and names as the values.'],
                ...
                'mail_template'     => ['title' => '邮件模板'      , 'description' => 'Use custom mail template. Specify template code like "gotech.forms::mail.notification" (found on Settings, Mail templates). Leave empty to use default.'],
