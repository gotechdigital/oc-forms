    ...
    return [
        ...
        'components' => [
            ...
            'shared' => [
                ...
                'mail_template'     => ['title' => 'Шаблон письма'      , 'description' => 'Используйте собственный шаблон письма. Укажите код шаблона, например, "gotech.forms::mail.notification" (находится в разделе Настройки -> Почтовые шаблоны). Оставьте пустым, чтобы использовать по умолчанию.'],
